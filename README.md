...
* [Ghost Browser](https://github.com/Wvdstoep/ghost-browser) - Open-source browser an AI agent operates via numbered Set-of-Mark annotations, with logged-in profiles, an act-gate for public actions, and record/replay.
